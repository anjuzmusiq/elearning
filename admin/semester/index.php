...
<body>
		...
		<div  class="main-panel ">
			...
			<div class="card mt-4 bg-light">
					...
					<?php
						...
						$sql1="SELECT * from tbl_semester limit $pageNo,$resultPerPage";
	...
	<?php
		if(isset($_SESSION['successFlag'])){
			if(($_SESSION['successFlag'])==1){
				custom_alert("Data inserted","You have entered a semester","success");
				unset($_SESSION['successFlag']);
			}
		}
		if(isset($_SESSION['deleteFlag'])){
			if(($_SESSION['deleteFlag'])==1){
				custom_alert("Deleted","You have successfully deleted the semester","success");
			...
			if (($_SESSION['updateFlag'])==1){
				custom_alert("Updated","You have successfully updated the semester","success");
