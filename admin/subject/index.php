...
//pagination
  $resultPerPage=10;
  $qry1="SELECT * from tbl_subject,tbl_program where tbl_subject.Prog_ID=tbl_program.ID";
...
$sql1="SELECT * from tbl_subject,tbl_program where tbl_subject.Prog_ID=tbl_program.ID order by tbl_subject.ID desc limit $pageNo,$resultPerPage";
...
<?php
        if(isset($_SESSION['successFlag'])){
            if(($_SESSION['successFlag'])==1){
                custom_alert("Success..!","Subject  added succesfully","success");
		...
		if(isset($_SESSION['pubFlag'])){
            if(($_SESSION['pubFlag'])==1){
                custom_alert("Success..!","Subject  published successfully","success");
		...
		if(isset($_SESSION['unpubFlag'])){
            if(($_SESSION['unpubFlag'])==1){
                custom_alert("Success..!","Subject  unpublished successfully","success");
                header("Location:index.php");
