<?php
    ...
    if(isset($_GET['updateid'])){
        $edit="SELECT * from tbl_program,tbl_department where tbl_program.Dep_ID = tbl_department.ID and tbl_program.ID=$updateid";
    ...
    if(isset($_POST['pname'])){
		...
		$editid= $updateid;
		$progobj= new Program();
		$retval=$progobj->updateProg($editid,$prog, $depID);
		if($retval == 1){
			header("Location: ..\..\admin\program\index.php");
		}
	}
?>
									...
									<div class="card-body">
										<form action="" method="POST">
											<div class="form-group">
												...
												<input type="text" name="pname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Program" value="<?php echo $row[1]; ?>">
											</div>
											<div class="form-group">
