									...
									<div class="card-body">
										<form method="POST" action="">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="exampleInputEmail1" name="dept" aria-describedby="emailHelp" placeholder="Enter Department"required>
