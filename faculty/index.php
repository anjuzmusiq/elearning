			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a href="#"><p style = "font-size: 1.1rem; color: black;">Dummy</p></a>
						</li>
						<li class="nav-item">
							<a href="#"><p style = "font-size: 1.1rem; color: black;">Dummy</p></a>
						</li>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="card text-center"id="ca">
								<a href="" style="text-decoration:none;" class="text-dark"title="Compiler Design">
									<div class="card-header">
									...
									<div class="card-body p-3">
											IMCA Batch 4<br>Semester 5<br>IMCA 501
									</div>
								</a>
							</div>
						</div>
						<div class="col-md-3">
							<div class="card  text-center" id="ca">
								<a href="" style="text-decoration:none;" title="Compiler Design">
									<div class="card-header">
										<div class="card-title"><button class="btn btn-link btn-primary btn-lg" style="padding:0px;padding-right:5px;cursor:context-menu;"><i class='fas fa-book-open fa-green'></i></button>
										Compiler Design
										</div>
						...
						<div class="col-md-3">
							<div class="card  text-center" id="ca">
								<a href="" style="text-decoration:none;" title="Compiler Design">
									<div class="card-header">
										<div class="card-title"><button class="btn btn-link btn-primary btn-lg" style="padding:0px;padding-right:5px;cursor:context-menu;"><i class='fas fa-book-reader fa-green'></i></button>
										Compiler Design
										</div>
									</div>
									<div class="card-body p-3">
